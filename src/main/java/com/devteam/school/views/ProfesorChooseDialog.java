...
public class ProfesorChooseDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form ProfesorChooseDialog
     */
    public ProfesorChooseDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jtProfesoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtProfesoresMouseClicked
        ...
        if(evt.getClickCount() == 2){
            int indexRowSelected = jtProfesores.rowAtPoint(evt.getPoint());
            transferData.transfer(profesores.get(indexRowSelected));
            dispose();
        }
    ...
    private void jbAcceptDialogMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbAcceptDialogMouseReleased
        // TODO add your handling code here:
        int indexRowSelected = jtProfesores.getSelectedRow();
        transferData.transfer(profesores.get(indexRowSelected));
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfesorChooseDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProfesorChooseDialog dialog = new ProfesorChooseDialog(new javax.swing.JFrame(), true);
